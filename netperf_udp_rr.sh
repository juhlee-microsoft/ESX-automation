...
echo $NETHOME/netperf $PORT -l $TEST_TIME -H $REM_HOST $STATS_STUFF $LOC_CPU $LOC_RATE $REM_CPU $REM_RATE -t UDP_RR -- -r $RR_SIZE -s $SOCKET_SIZE -S $SOCKET_SIZE
$NETHOME/netperf $PORT -l $TEST_TIME -H $REM_HOST $STATS_STUFF $LOC_CPU $LOC_RATE $REM_CPU $REM_RATE -t UDP_RR $NO_HDR -- -r $RR_SIZE -s $SOCKET_SIZE -S $SOCKET_SIZE
done
done
echo
